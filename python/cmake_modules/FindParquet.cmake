...
if (MSVC)
  ...
  find_library(PARQUET_SHARED_LIBRARIES NAMES parquet
    ...
    PATH_SUFFIXES "bin" )
  message(STATUS "!!! PARQUET_SHARED_LIBRARIES value: ${PARQUET_SHARED_LIBRARIES}")
...
message(STATUS "!!! PARQUET_HOME value: ${PARQUET_HOME}")
if(PARQUET_HOME)
    message(STATUS "Getting parquet from PARQUET_HOME variable...")
